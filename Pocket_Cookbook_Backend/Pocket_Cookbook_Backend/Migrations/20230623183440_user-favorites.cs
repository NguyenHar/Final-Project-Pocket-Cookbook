        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    resultFK = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_userFavorites", x => x.primary_key_id);
                    table.ForeignKey(
                        name: "FK_userFavorites_Results_resultFK",
                        column: x => x.resultFK,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_userFavorites_resultFK",
                table: "userFavorites",
                column: "resultFK");
        }
